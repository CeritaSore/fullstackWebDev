    ...
    <ul class="navbar-nav">
      <li class="nav-item font-weight-semibold d-none d-lg-block ms-0">
        <h1 class="welcome-text">
          Good Morning, <span class="text-black fw-bold">Fajar septianto</span>
        </h1>
        ...
        >
          <div class="dropdown-header text-center">
            <img
              ...
              alt="Profile image"
            />
            <p class="mb-1 mt-3 font-weight-semibold">Fajar septianto</p>
            <p class="fw-light text-muted mb-0">fajarseptianto@gmail.com</p>
          </div>
